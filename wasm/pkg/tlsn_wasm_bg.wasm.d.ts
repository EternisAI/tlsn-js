...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he0f34c32adc88c09(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he8adcd7643240185(a: number, b: number, c: number): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__hc46c826fb5db5c75(a: number, b: number, c: number, d: number): void;
